...
class PaginatedQueryShapes(UniversalBaseModel):
    """
    Paginated collection of query shapes. This endpoint returns a maximum of 100 results.
    """
    ...
    results: typing.Optional[typing.List[QueryShapeResponse]] = pydantic.Field(default=None)
    """

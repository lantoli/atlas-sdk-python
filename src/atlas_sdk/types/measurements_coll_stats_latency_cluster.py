...
class MeasurementsCollStatsLatencyCluster(UniversalBaseModel):
    cluster_id: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="clusterId"),
        pydantic.Field(alias="clusterId", description="Unique identifier for Clusters."),
    ] = None
    cluster_view: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="clusterView"),
        pydantic.Field(alias="clusterView", description="Cluster topology view."),
    ] = None
    ...
    measurements: typing.Optional[typing.List[MetricsMeasurement]] = pydantic.Field(default=None)
    """

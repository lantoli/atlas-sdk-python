...
class MeasurementsIndexes(UniversalBaseModel):
    collection_name: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="collectionName"),
        pydantic.Field(alias="collectionName", description="Human-readable label that identifies the collection."),
    ] = None
    ...
    index_ids: typing_extensions.Annotated[
        typing.Optional[typing.List[str]],
        FieldMetadata(alias="indexIds"),
        pydantic.Field(alias="indexIds", description="List that contains the Atlas Search index identifiers."),
    ] = None
    index_stats_measurements: typing_extensions.Annotated[
        typing.Optional[typing.List[MetricsMeasurement]],
        FieldMetadata(alias="indexStatsMeasurements"),
        pydantic.Field(
            alias="indexStatsMeasurements", description="List that contains the Atlas Search index stats measurements."
        ),
    ] = None

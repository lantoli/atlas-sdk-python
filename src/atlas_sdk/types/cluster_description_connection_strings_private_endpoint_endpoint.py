...
class ClusterDescriptionConnectionStringsPrivateEndpointEndpoint(UniversalBaseModel):
    """
    ...
    provider_name: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="providerName", description="Cloud provider in which MongoDB Cloud deploys the private endpoint."
        ),
    ] = None

...
class PaginatedRateLimitEndpointSets(UniversalBaseModel):
    """
    A list of rate limit endpoint sets.
    """
    ...
    results: typing.Optional[typing.List[RateLimitEndpointSetResponse]] = pydantic.Field(default=None)
    """
